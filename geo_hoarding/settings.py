"""
Django settings for geo_hoarding project.
...
SECRET_KEY = 'django-insecure-n%7xfj99wh4m*zs^kxr4j*f3cz^(zf0e)ny-8+%1@cd@p)vk(w'
...
ROOT_URLCONF = 'geo_hoarding.urls'
...
# ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '39be9ac4af18.ngrok-free.app']
